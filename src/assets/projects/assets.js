...
export const proj = [
    ...
    {
        proj_image: proj4,
		proj_url: "https://github.com/ShrutiPatil-dev/todolist",
		proj_title: "Todo List",
		proj_description:"The To-Do List Application is a simple yet powerful tool designed to help users manage their tasks efficiently. It allows users to add, view, search, and delete tasks in an organized manner",
